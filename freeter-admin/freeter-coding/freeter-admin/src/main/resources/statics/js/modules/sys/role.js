...
var vm = new Vue({
    ...
    methods: {
        ...
        getRole: function(roleId){
            $.get(baseURL + "sys/role/info/"+roleId, function(r){
                ...
                for(var i=0; i<deptIds.length; i++) {
                    var node = data_ztree.getNodeByParam("orgId", deptIds[i]);
        ...
        getDataTree: function(roleId) {
            //加载菜单树
            $.get(baseURL + "room/organization/list", function(r){
        ...
        getDept: function(){
            ...
            $.get(baseURL + "room/organization/list", function(r){
                ...
                var node = dept_ztree.getNodeByParam("orgId", vm.role.deptId);
                if(node != null){
